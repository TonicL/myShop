<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/Users/apple/Sites/workspace/tpshop/public/../application/home/view/cart/flow2.html";i:1522065357;s:69:"/Users/apple/Sites/workspace/tpshop/application/home/view/layout.html";i:1522031245;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="clear"></div>
			...
			<div class="paycont">
				<div class="address">
					...
					<ul>
						...
						<li address_id="<?php echo $v['id']; ?>" class="user-addresslist <?php if($k == 0): ?>defaultAddr<?php endif; ?>">
				...
				<div class="logistics">
					<h3>选择支付方式</h3>
					<ul class="pay-list">
						<li class="pay card" pay_type="0"><img src="/static/home/images/wangyin.jpg" />银联<span></span></li>
						<li class="pay qq" pay_type="1"><img src="/static/home/images/weizhifu.jpg" />微信<span></span></li>
						<li class="pay taobao selected" pay_type="2"><img src="/static/home/images/zhifubao.jpg" />支付宝<span></span></li>
					</ul>
				</div>
				<div class="clear"></div>
							...
							<div class="bundle  bundle-last">
								...
								<div class="bundle-main">
									<ul class="item-content clearfix">
											...
											<li class="td td-item">
												...
												<div class="item-info">
													<div class="item-basic-info">
														<a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11"><?php echo $v['goods']['goods_name']; ?></a>
													</div>
												</div>
											</li>
											<li class="td td-info">
											...
											<li class="td td-price">
												<div class="item-price price-promo-promo">
													<div class="price-content">
														<em class="J_Price price-now"><?php echo $v['goods']['goods_price']; ?></em>
													</div>
												</div>
											</li>
										</div>
										...
										<li class="td td-sum">
											<div class="td-inner">
												<em tabindex="0" class="J_ItemSum number"><?php echo $v['goods']['goods_price'] * $v['number']; ?></em>
											</div>
										</li>
		...
		<div class="clear"></div>
		<form action="<?php echo url('home/cart/createorder'); ?>" id="orderForm" method="post" style="display:none">
