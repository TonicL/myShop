<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/Users/apple/Sites/workspace/tpshop/public/../application/home/view/goods/detail.html";i:1521944166;s:69:"/Users/apple/Sites/workspace/tpshop/application/home/view/layout.html";i:1522031245;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="clearfixLeft" id="clearcontent">
			...
			<div class="box">
				...
				<div class="tb-booth tb-pic tb-s310">
					<a href="javascript:;"><img src="<?php echo $goodspics[0]['pics_mid']; ?>" alt="细节展示放大镜特效" rel="<?php echo $goodspics[0]['pics_big']; ?>" class="jqzoom" /></a>
				</div>
				<ul class="tb-thumb" id="thumblist">
					<?php foreach($goodspics as $k=>$v): ?>
					<li class="<?php if($k == 0): ?>tb-selected<?php endif; ?>">
						<div class="tb-pic tb-s40">
							<a href="javascript:;"><img src="<?php echo $v['pics_sma']; ?>" mid="<?php echo $v['pics_mid']; ?>" big="<?php echo $v['pics_big']; ?>"></a>
						</div>
					</li>
					<?php endforeach; ?>
				</ul>
					...
					<dd>
						...
						<div class="theme-popover">
							...
							<div class="theme-popbod dform">
								<form class="theme-signin" name="goodsform" action="<?php echo url('home/cart/addcart'); ?>" method="post">
									...
									<div class="theme-signin-left">
										...
										<div class="theme-options">
											<div class="cart-title attr_name"><?php echo $v['attr_name']; ?></div>
											<ul>
												<?php foreach($goodsattr as $value): if($value['attr_id'] == $v['id']): ?>
												<li goods_attr_id="<?php echo $value['id']; ?>" class="sku-line"><?php echo $value['attr_value']; ?><i></i></li>
				...
				<div class="am-tab-panel am-fade am-in am-active">
					<div class="J_Brand">
						...
						<ul id="J_AttrUL">
							...
							<li title=""><?php echo $v['attr_name']; ?>:&nbsp;
								<?php foreach($goodsattr as $value): if($value['attr_id'] == $v['id']): ?>
								<?php echo $value['attr_value']; endif; endforeach; ?>
							</li>
							<?php endif; endforeach; ?>
						</ul>
						<div class="clear"></div>
...
<script>
	$(function(){
		...
		$('#LikBasket').click(function(){
			//获取到选中的属性值 对应的li标签
			var li_selected = $('.selected');
			//获取属性名称对应的div  用来判断选中的个数
			var attr_div = $('.attr_name');
			if(li_selected.length != attr_div.length){
				alert('必须选择商品属性');return;
			}
			var goods_attr_ids = ''; //  12,24,25
			$.each(li_selected, function(i,v){
				//v 就是一个li标签，DOM对象
